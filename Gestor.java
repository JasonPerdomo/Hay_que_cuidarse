...
public class Gestor {
  ...
  /**
   * Set the value of NumeroGestores
   * @param newVar the new value of NumeroGestores
   */
  protected void setNumeroGestores (int newVar) {
    NumeroGestores = newVar;
  }

  /**
   * Get the value of NumeroGestores
   * @return the value of NumeroGestores
   */
  protected int getNumeroGestores () {
  ...
  /**
   */
  private void agregarNutrcionista()
  {
  }
